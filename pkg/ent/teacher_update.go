...
func (tu *TeacherUpdate) SetTeacherID(i int32) *TeacherUpdate {
	tu.mutation.ResetTeacherID()
	tu.mutation.SetTeacherID(i)
	return tu
}

// AddTeacherID adds i to the "teacher_id" field.
func (tu *TeacherUpdate) AddTeacherID(i int32) *TeacherUpdate {
	tu.mutation.AddTeacherID(i)
	return tu
}
...
func (tu *TeacherUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := tu.mutation.AddedTeacherID(); ok {
		_spec.AddField(teacher.FieldTeacherID, field.TypeInt32, value)
	}
...
// SetTeacherID sets the "teacher_id" field.
func (tuo *TeacherUpdateOne) SetTeacherID(i int32) *TeacherUpdateOne {
	tuo.mutation.ResetTeacherID()
	tuo.mutation.SetTeacherID(i)
	return tuo
}

// AddTeacherID adds i to the "teacher_id" field.
func (tuo *TeacherUpdateOne) AddTeacherID(i int32) *TeacherUpdateOne {
	tuo.mutation.AddTeacherID(i)
	return tuo
}
...
func (tuo *TeacherUpdateOne) sqlSave(ctx context.Context) (_node *Teacher, err error) {
	...
	if value, ok := tuo.mutation.AddedTeacherID(); ok {
		_spec.AddField(teacher.FieldTeacherID, field.TypeInt32, value)
	}
