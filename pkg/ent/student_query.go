...
func (sq *StudentQuery) QueryTeacher() *TeacherQuery {
	query := &TeacherQuery{config: sq.config}
...
func (sq *StudentQuery) Clone() *StudentQuery {
	...
	return &StudentQuery{
		...
		withTeacher: sq.withTeacher.Clone(),
...
func (sq *StudentQuery) WithTeacher(opts ...func(*TeacherQuery)) *StudentQuery {
	query := &TeacherQuery{config: sq.config}
	for _, opt := range opts {
		opt(query)
	}
	sq.withTeacher = query
	return sq
}
...
func (sq *StudentQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Student, error) {
	...
	if query := sq.withTeacher; query != nil {
		if err := sq.loadTeacher(ctx, query, nodes, nil,
			func(n *Student, e *Teacher) { n.Edges.Teacher = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (sq *StudentQuery) loadTeacher(ctx context.Context, query *TeacherQuery, nodes []*Student, init func(*Student), assign func(*Student, *Teacher)) error {
